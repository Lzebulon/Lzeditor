...
use std::{ops::{Add, Mul, Sub}, ffi::c_uint};
...
pub struct KeyboardKeyQueue();

impl KeyboardKeyQueue {
    pub fn new() -> Self {
        Self()
    }
}

impl Iterator for  KeyboardKeyQueue {
    type Item = c_uint;
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        if next_key == 0 {
            ...
            Some(next_key as c_uint)
        }
    }
}

pub struct CharsQueue();
